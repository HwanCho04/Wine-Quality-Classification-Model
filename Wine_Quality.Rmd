...
# Scale test set using trained set parameters
...
# Create levels 0 and 1 for our target variable
...
# Refit logistic model using selected features - remove chlorides
